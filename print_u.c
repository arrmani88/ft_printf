...
/*   Updated: 2019/10/25 19:13:29 by anel-bou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		print2(t_arg lst, t_var *v)
{
	...
	if (v->n == 0 && lst.precision == -1 && lst.point)
		cond = 0;
	if (v->f_zr && !cond && (v->f_spc = v->f_zr) && v->signe && v->f_spc++)
		v->f_zr = 0;
...
void	ft_continue2(t_var *v, t_arg lst)
{
